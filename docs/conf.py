...
autodoc_mock_imports = ['scipy.io', 'brian2' , 'ntpath','numpy', 'scipy.io', 'os', 'cPickle', 'zlib','bz2','shutil', 'multiprocessing', 'time','pandas', 'itertools','brian2genn', 'ast','ntpath','scipy.sparse','datetime','time','__builtin__','csv','threading','networkx.drawing','random','operator','matplotlib']
