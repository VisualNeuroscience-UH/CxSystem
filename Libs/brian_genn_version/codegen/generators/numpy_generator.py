...
from brian_genn_version.parsing.rendering import NumpyNodeRenderer
from brian_genn_version.core.functions import DEFAULT_FUNCTIONS, Function
from brian_genn_version.core.variables import ArrayVariable
from brian_genn_version.utils.stringtools import get_identifiers, word_substitute, indent
...
class NumpyCodeGenerator(CodeGenerator):
    ...
    def ufunc_at_vectorisation(self, statement, variables, indices,
        ...
        # See https://github.com/brian-team/brian_genn_version/pull/531 for explanation
