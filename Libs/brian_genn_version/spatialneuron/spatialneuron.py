...
from brian_genn_version.equations.equations import (Equations, PARAMETER, SUBEXPRESSION,
                                        DIFFERENTIAL_EQUATION)
from brian_genn_version.groups.group import Group, CodeRunner, create_runner_codeobj
from brian_genn_version.units.allunits import ohm, siemens, amp
from brian_genn_version.units.fundamentalunits import Unit, fail_for_dimension_mismatch
from brian_genn_version.units.stdunits import uF, cm
from brian_genn_version.parsing.sympytools import sympy_to_str
from brian_genn_version.utils.logger import get_logger
from brian_genn_version.groups.neurongroup import NeuronGroup
from brian_genn_version.groups.subgroup import Subgroup
from brian_genn_version.equations.codestrings import Expression
...
class SpatialStateUpdater(CodeRunner, Group):
    ...
    def before_run(self, run_namespace=None, level=0):
        ...
        from brian_genn_version.codegen.runtime.numpy_rt.numpy_rt import NumpyCodeObject
