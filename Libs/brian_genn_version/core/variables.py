...
from brian_genn_version.utils.stringtools import get_identifiers, word_substitute
from brian_genn_version.units.fundamentalunits import (Quantity, Unit, DIMENSIONLESS,
...
class Subexpression(Variable):
    ...
    def __init__(self, name, unit, owner, expr, device, dtype=None,
        ...
        if scalar:
            from brian_genn_version.parsing.sympytools import str_to_sympy
...
class VariableView(object):
    ...
    def set_with_expression(self, item, code, check_units=True, level=0,
        ...
        if hasattr(item, 'variables') or (isinstance(item, tuple)
            ...
            from brian_genn_version.codegen.translation import get_identifiers_recursively
