...
from brian_genn_version.utils.stringtools import deindent, indent
...
class BrianGlobalPreferences(MutableMapping):
    ...
    def __init__(self):
        ...
        exec deindent('''
            ...
            from brian_genn_version.units.stdunits import *
    ...
    def load_preferences(self):
        ...
        1. ``brian_genn_version/default_preferences`` from the Brian installation directory.
