...
from brian_genn_version.groups.group import VariableOwner
from brian_genn_version.units.fundamentalunits import check_units, Quantity, Unit
...
class DefaultClockProxy(object):
    ...
    def __getattr__(self, name):
        if name == '_is_proxy':
            return True
        from brian_genn_version.devices.device import active_device
