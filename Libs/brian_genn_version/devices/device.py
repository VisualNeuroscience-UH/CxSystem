...
from brian_genn_version.codegen.runtime.numpy_rt import NumpyCodeObject
from brian_genn_version.core.clocks import Clock
import brian_genn_version.core.clocks as clocks
from brian_genn_version.core.names import find_name
from brian_genn_version.core.preferences import prefs
from brian_genn_version.core.variables import ArrayVariable, DynamicArrayVariable
from brian_genn_version.core.functions import Function
from brian_genn_version.units import ms
from brian_genn_version.utils.logger import get_logger
from brian_genn_version.utils.stringtools import code_representation, indent
...
class RuntimeDevice(Device):
    ...
    def spike_queue(self, source_start, source_end):
        ...
        try:
            from brian_genn_version.synapses.cythonspikequeue import SpikeQueue
            logger.info('Using the C++ SpikeQueue', once=True)
        except ImportError:
            from brian_genn_version.synapses.spikequeue import SpikeQueue
...
def restore_device():
    from brian_genn_version import restore_initial_state  # avoids circular import
