...
CM = CX.cortical_system (os.path.dirname(os.path.realpath(__file__)) + '/Test_config_file.csv' , os.getcwd(), result_filename ='Custom_Name.mat',use_genn=0,runtime=1000*ms )
