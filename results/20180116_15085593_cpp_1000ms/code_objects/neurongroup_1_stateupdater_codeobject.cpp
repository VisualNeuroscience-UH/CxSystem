...
void _run_neurongroup_1_stateupdater_codeobject()
{
	...
	///// CONSTANTS ///////////
	const int _numvm = 800;
const int _numgi_soma = 800;
const int _numlastspike = 800;
const int _numnot_refractory = 800;
const int _numge_soma = 800;
const int _numdt = 1;
const int _numt = 1;
	///// POINTERS ////////////
 ...
 const double _lio_3 = ((0.002 * 4.3402450518378885e-09) * exp((- (-0.05)) / 0.002)) / 9.21e-11;
 const double _lio_4 = 1.0 / 0.002;
 const double _lio_5 = ((-0.049) * 4.3402450518378885e-09) / 9.21e-11;
 const double _lio_6 = 0.0 / 9.21e-11;
 const double _lio_7 = (-0.075) / 9.21e-11;
 const double _lio_8 = 4.3402450518378885e-09 / 9.21e-11;
 const double _lio_9 = 1.0 / 9.21e-11;
 const double _lio_10 = 0.0 * (_brian_pow(0.02122, -0.5));
