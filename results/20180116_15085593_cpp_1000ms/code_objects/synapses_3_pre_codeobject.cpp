...
void _run_synapses_3_pre_codeobject()
{
	...
	///// CONSTANTS ///////////
	const int _numgi_soma_post = 800;
...
double* const _array_synapses_3_wght = _dynamic_array_synapses_3_wght.empty()? 0 : &_dynamic_array_synapses_3_wght[0];
const int _numwght = _dynamic_array_synapses_3_wght.size();
	///// POINTERS ////////////
 ...
 double* __restrict  _ptr_array_synapses_3_wght = _array_synapses_3_wght;
   ...
   double gi_soma_post = _ptr_array_neurongroup_1_gi_soma[_postsynaptic_idx];
   const double wght = _ptr_array_synapses_3_wght[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   gi_soma_post += wght;
   lastupdate = t;
   _ptr_array_neurongroup_1_gi_soma[_postsynaptic_idx] = gi_soma_post;
