...
double* const _array_synapses_1_wght = _dynamic_array_synapses_1_wght.empty()? 0 : &_dynamic_array_synapses_1_wght[0];
const int _numwght = _dynamic_array_synapses_1_wght.size();
const int _numge_soma_post = 800;
	///// POINTERS ////////////
 ...
 double* __restrict  _ptr_array_synapses_1_wght = _array_synapses_1_wght;
 double* __restrict  _ptr_array_neurongroup_1_ge_soma = _array_neurongroup_1_ge_soma;
   ...
   const double wght = _ptr_array_synapses_1_wght[_idx];
   double ge_soma_post = _ptr_array_neurongroup_1_ge_soma[_postsynaptic_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   ge_soma_post += wght;
   lastupdate = t;
   _ptr_array_synapses_1_lastupdate[_idx] = lastupdate;
   _ptr_array_neurongroup_1_ge_soma[_postsynaptic_idx] = ge_soma_post;
