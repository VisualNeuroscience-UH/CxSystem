...
void _run_synapses_2_pre_codeobject()
{
	...
	///// CONSTANTS ///////////
	const int _numgi_soma_post = 3200;
...
double* const _array_synapses_2_wght = _dynamic_array_synapses_2_wght.empty()? 0 : &_dynamic_array_synapses_2_wght[0];
const int _numwght = _dynamic_array_synapses_2_wght.size();
	///// POINTERS ////////////
 ...
 double* __restrict  _ptr_array_synapses_2_wght = _array_synapses_2_wght;
   ...
   double gi_soma_post = _ptr_array_neurongroup_gi_soma[_postsynaptic_idx];
   const double wght = _ptr_array_synapses_2_wght[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   gi_soma_post += wght;
   lastupdate = t;
   _ptr_array_neurongroup_gi_soma[_postsynaptic_idx] = gi_soma_post;
