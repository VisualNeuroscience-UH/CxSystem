...
from brian_genn_version.numpy_ import *
from brian_genn_version.units.allunits import meter
from brian_genn_version.utils.logger import get_logger
from brian_genn_version.units.stdunits import um
from brian_genn_version.units.fundamentalunits import (have_same_dimensions, Quantity,
                                           check_units)
...
class MorphologyIndexWrapper(object):
    '''
    A simpler version of `~brian_genn_version.groups.group.IndexWrapper`, not allowing for
