...
from brian_genn_version.core.variables import (DynamicArrayVariable, ArrayVariable,
...
from brian_genn_version.utils.logger import std_silent, get_logger
...
class WeaveCodeObject(CodeObject):
    ...
    '''
    templater = Templater('brian_genn_version.codegen.runtime.weave_rt',
