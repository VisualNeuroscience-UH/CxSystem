...
from brian_genn_version.units.fundamentalunits import standard_unit_register
from brian_genn_version.units.stdunits import stdunits
from brian_genn_version.core.functions import DEFAULT_FUNCTIONS, DEFAULT_CONSTANTS
...
def _get_default_unit_namespace():
    ...
    `brian_genn_version.units.stdunits` (ms, mV, nS, etc.).
