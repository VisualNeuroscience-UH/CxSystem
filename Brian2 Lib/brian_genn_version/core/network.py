...
from brian_genn_version.devices.device import device
from brian_genn_version.units.fundamentalunits import check_units, DimensionMismatchError
from brian_genn_version.units.allunits import second, msecond 
...
def _format_time(time_in_s):
    ...
    Examples
    --------
    >>> from brian_genn_version.core.network import _format_time
    >>> _format_time(12345)
    '3h 25m 45s'
    >>> _format_time(123)
    '2m 3s'
...
class Network(Nameable):
    ...
    def before_run(self, run_namespace=None, level=0):
        ...
        '''
        from brian_genn_version.devices.device import get_device, all_devices
