...
from brian_genn_version.core.namespace import (DEFAULT_FUNCTIONS,
                                   DEFAULT_CONSTANTS,
                                   DEFAULT_UNITS)
from brian_genn_version.core.variables import Constant
from brian_genn_version.core.functions import Function
from brian_genn_version.parsing.sympytools import sympy_to_str, str_to_sympy
from brian_genn_version.units.fundamentalunits import (Unit, Quantity, have_same_dimensions,
                                           get_unit, DIMENSIONLESS,
                                           DimensionMismatchError)
from brian_genn_version.units.allunits import (metre, meter, second, amp, kelvin, mole,
...
def parse_string_equations(eqns):
    ...
    equations : dict
        ...
        `~brian_genn_version.equations.equations.Equations` objects
    """
    equations = {}
