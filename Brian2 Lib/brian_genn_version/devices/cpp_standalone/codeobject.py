...
'''
from brian_genn_version.codegen.codeobject import CodeObject, constant_or_scalar
...
class CPPStandaloneCodeObject(CodeObject):
    ...
    The ``code`` should be a `~brian_genn_version.codegen.templates.MultiTemplate`
    object with two macros defined, ``main`` (for the main loop code) and
    ``support_code`` for any support code (e.g. function definitions).
    '''
    templater = Templater('brian_genn_version.devices.cpp_standalone',
