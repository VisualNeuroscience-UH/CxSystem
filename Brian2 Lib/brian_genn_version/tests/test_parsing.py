'''
Tests the brian_genn_version.parsing package
'''
...
from brian_genn_version.codegen.generators.cpp_generator import CPPCodeGenerator
from brian_genn_version.codegen.runtime.weave_rt.weave_rt import get_compiler_and_args
...
from brian_genn_version.utils.stringtools import get_identifiers, deindent
from brian_genn_version.utils.logger import std_silent
from brian_genn_version.parsing.rendering import (NodeRenderer, NumpyNodeRenderer,
                                      CPPNodeRenderer,
                                      )
from brian_genn_version.parsing.dependencies import abstract_code_dependencies
from brian_genn_version.parsing.expressions import (is_boolean_expression,
...
from brian_genn_version.parsing.functions import (abstract_code_from_function,
                                      extract_abstract_code_functions,
                                      substitute_abstract_code_functions)
from brian_genn_version.units import (volt, amp, DimensionMismatchError,
