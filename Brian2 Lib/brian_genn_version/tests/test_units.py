...
from brian_genn_version.units.fundamentalunits import (UFUNCS_DIMENSIONLESS,
...
from brian_genn_version.units.allunits import *
from brian_genn_version.units.stdunits import ms, mV, kHz, nS, cm
...
def test_unit_discarding_functions():
    ...
    '''
    from brian_genn_version.units.unitsafefunctions import zeros_like, ones_like
...
def test_unitsafe_functions():
    ...
    '''
    from brian_genn_version.units.unitsafefunctions import (sin, sinh, arcsin, arcsinh,
...
def test_special_case_numpy_functions():
    ...
    '''
    from brian_genn_version.units.unitsafefunctions import ravel, diagonal, trace, dot, where
...
def test_switching_off_unit_checks():
    ...
    '''
    import brian_genn_version.units.fundamentalunits as fundamentalunits
    x = 3 * second
    y = 5 * volt    
