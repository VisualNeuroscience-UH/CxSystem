...
This will be removed as soon as brian_genn_versionhears is working.
...
try:
    ...
    raise ImportError("brian_genn_version.hears is a temporary bridge between Brian 2 and the version of Brian Hears from "
                      "Brian 1, you need to have Brian 1 installed to use it.")

from brian_genn_version.core.clocks import Clock
from brian_genn_version.core.operations import network_operation
from brian_genn_version.groups.neurongroup import NeuronGroup
from brian_genn_version.utils.logger import get_logger
from brian_genn_version.units.fundamentalunits import Quantity
...
def modify_arg(arg):
    ...
    is a sequence, but because brian_genn_version.Quantity derives from ndarray this was causing problems.
    '''
