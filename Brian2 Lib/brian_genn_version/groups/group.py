...
from brian_genn_version.core.base import BrianObject
from brian_genn_version.core.names import Nameable
from brian_genn_version.core.preferences import prefs
from brian_genn_version.core.variables import (Variables, Constant, Variable,
                                   ArrayVariable, DynamicArrayVariable,
                                   Subexpression)
from brian_genn_version.core.functions import Function
from brian_genn_version.core.namespace import (get_local_namespace,
                                   DEFAULT_FUNCTIONS,
                                   DEFAULT_UNITS,
                                   DEFAULT_CONSTANTS)
from brian_genn_version.codegen.codeobject import create_runner_codeobj, check_code_units
from brian_genn_version.equations.equations import BOOLEAN, INTEGER, FLOAT
...
from brian_genn_version.utils.stringtools import get_identifiers, SpellChecker
    ...
    def __getitem__(self, item):
        if isinstance(item, basestring):
            ...
            check_code_units(abstract_code, self.group,
                             ...
                             level=1)
            from brian_genn_version.devices.device import get_default_codeobject_class
