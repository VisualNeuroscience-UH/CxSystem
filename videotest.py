...
OpenCV has to be built manually to enable reading/writing of videos (via FFMPEG). For some reason,
there seems to be no prebuilt package via Anaconda.

These two helped:
https://pearsonlab.github.io/blog/2016/04/06/opencv-videos.html
